      ...
      <div>
        <div className="py-8 lg:py-12 px-14 mx-auto max-w-screen-md ">
          ...
          <form action="#" className="space-y-7 ">
            <div>
              <label htmlFor="nome" className="block mb-2 text-sm font-medium font-bold text-gray-900">Seu nome</label>
            ...
            <div>
              <label htmlFor="email" className="block mb-2 text-sm font-medium font-bold text-gray-900">Seu email</label>
